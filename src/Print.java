...
public class Print {
    /**
     * Выводит список дублирующихся адресов из записей.
     *
     * @param records список записей
     */
    public static void printDuplicates(List<Map<String, String>> records) {
    ...
    /**
     * Выводит статистику количества зданий по этажам для каждого города.
     *
     * @param records список записей
     */
    public static void printFloorStats(List<Map<String, String>> records) {
